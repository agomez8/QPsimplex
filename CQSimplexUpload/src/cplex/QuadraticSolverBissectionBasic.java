...
public class QuadraticSolverBissectionBasic extends CplexSolver {
     ...
     */
    public QuadraticSolverBissectionBasic(double Omega, double[] linearObjective) throws IloException {
        super();
        this.Omega = Omega;
     ...
     */
    public QuadraticSolverBissectionBasic(double Omega, double[] linearObjective, IloCplex cplex, IloNumVar[] x, IloRange[] constraints, IloLinearNumExpr linearPart, IloQuadNumExpr quadraticPart) {
